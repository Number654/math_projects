...
class UiTruthtableWindow(object):
    ...
    def setupUi(self, truthtable_window):
        ...
        self.check_if_last.setChecked(True)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.fragment_table.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.fragment_table.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.fragment_table.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.fragment_table.setTabKeyNavigation(False)
        ...
        self.results_list = QtWidgets.QListWidget(self.result_group)
